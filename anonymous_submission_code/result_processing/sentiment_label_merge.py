...
from common.pipeline_utils import ordered_sentiment_entries, resolve_dataset_base
...
def merge_corrected_labels(results_root: Path | str = "results"):
    ...
    if not entries:
        raise RuntimeError("No pipeline metadata found. Run model training and inference first.")
