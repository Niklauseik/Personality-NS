...
Files:
- `benchmark_drop_ttest_inputs.csv`: row-level benchmark deltas used as t-test inputs.
- `benchmark_drop_ttest_variant_overall.csv`: per tuned variant mean delta across benchmark datasets.
