...
DEFAULT_INPUT = "BENCHMARK_CAPABILITY_CHANGES_BY_DATASET.md"
DEFAULT_OUTPUT_DIR = "global_summaries"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Stage-3: one-sided drop t-test for benchmark capability deltas."
    )
    parser.add_argument(
        "--input",
